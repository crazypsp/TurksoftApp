...
// wwwroot/js/api/entities/Teklif.js
// ======================================================================
...
// (4) CRUD işlevleri
async function list(params = null)  { return svc.list(params);  } // GET /teklif
async function get(id)              { return svc.get(id);        } // GET /teklif/{id}
async function create(data)         { return svc.create(data);   } // POST /teklif
async function update(id, data)     { return svc.update(id, data);} // PUT  /teklif/{id}
async function remove(id)           { return svc.remove(id);     } // DELETE /teklif/{id}

// (5) Export
export const TeklifApi = { list, get, create, update, remove };
export default TeklifApi;
