...
// wwwroot/js/api/entities/BayiKomisyonTarife.js
// ======================================================================
...
const RESOURCE = 'bayikomisyontarife';
...
// (4) CRUD işlevleri
async function list(params = null)  { return svc.list(params);  } // GET /bayikomisyontarife
async function get(id)              { return svc.get(id);        } // GET /bayikomisyontarife/{id}
async function create(data)         { return svc.create(data);   } // POST /bayikomisyontarife
async function update(id, data)     { return svc.update(id, data);} // PUT  /bayikomisyontarife/{id}
async function remove(id)           { return svc.remove(id);     } // DELETE /bayikomisyontarife/{id}

// (5) Export
export const BayiKomisyonTarifeApi = { list, get, create, update, remove };
export default BayiKomisyonTarifeApi;
