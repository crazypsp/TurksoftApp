...
// wwwroot/js/api/entities/FaturaKalem.js
// ======================================================================
...
// (4) CRUD işlevleri
async function list(params = null)  { return svc.list(params);  } // GET /faturakalem
async function get(id)              { return svc.get(id);        } // GET /faturakalem/{id}
async function create(data)         { return svc.create(data);   } // POST /faturakalem
async function update(id, data)     { return svc.update(id, data);} // PUT  /faturakalem/{id}
async function remove(id)           { return svc.remove(id);     } // DELETE /faturakalem/{id}

// (5) Export
export const FaturaKalemApi = { list, get, create, update, remove };
export default FaturaKalemApi;
