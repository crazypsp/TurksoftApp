...
// wwwroot/js/api/entities/Firma.js
// ======================================================================
...
// (4) CRUD işlevleri
async function list(params = null)  { return svc.list(params);  } // GET /firma
async function get(id)              { return svc.get(id);        } // GET /firma/{id}
async function create(data)         { return svc.create(data);   } // POST /firma
async function update(id, data)     { return svc.update(id, data);} // PUT  /firma/{id}
async function remove(id)           { return svc.remove(id);     } // DELETE /firma/{id}

// (5) Export
export const FirmaApi = { list, get, create, update, remove };
