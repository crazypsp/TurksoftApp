...
// wwwroot/js/api/entities/SmsAyar.js
// ======================================================================
...
// (4) CRUD işlevleri
async function list(params = null)  { return svc.list(params);  } // GET /smsayar
async function get(id)              { return svc.get(id);        } // GET /smsayar/{id}
async function create(data)         { return svc.create(data);   } // POST /smsayar
async function update(id, data)     { return svc.update(id, data);} // PUT  /smsayar/{id}
async function remove(id)           { return svc.remove(id);     } // DELETE /smsayar/{id}

// (5) Export
export const SmsAyarApi = { list, get, create, update, remove };
export default SmsAyarApi;
