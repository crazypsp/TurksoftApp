...
// wwwroot/js/api/entities/VergiOrani.js
// ======================================================================
...
// (4) CRUD işlevleri
async function list(params = null)  { return svc.list(params);  } // GET /vergiorani
async function get(id)              { return svc.get(id);        } // GET /vergiorani/{id}
async function create(data)         { return svc.create(data);   } // POST /vergiorani
async function update(id, data)     { return svc.update(id, data);} // PUT  /vergiorani/{id}
async function remove(id)           { return svc.remove(id);     } // DELETE /vergiorani/{id}

// (5) Export
export const VergiOraniApi = { list, get, create, update, remove };
export default VergiOraniApi;
