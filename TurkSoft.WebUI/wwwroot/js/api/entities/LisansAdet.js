...
// wwwroot/js/api/entities/LisansAdet.js
// ======================================================================
...
// (4) CRUD işlevleri
async function list(params = null)  { return svc.list(params);  } // GET /lisansadet
async function get(id)              { return svc.get(id);        } // GET /lisansadet/{id}
async function create(data)         { return svc.create(data);   } // POST /lisansadet
async function update(id, data)     { return svc.update(id, data);} // PUT  /lisansadet/{id}
async function remove(id)           { return svc.remove(id);     } // DELETE /lisansadet/{id}

// (5) Export
export const LisansAdetApi = { list, get, create, update, remove };
export default LisansAdetApi;
