...
// wwwroot/js/api/entities/KomisyonOdemePlani.js
// ======================================================================
...
const RESOURCE = 'komisyonodemeplani';
...
// (4) CRUD işlevleri
async function list(params = null)  { return svc.list(params);  } // GET /komisyonodemeplani
async function get(id)              { return svc.get(id);        } // GET /komisyonodemeplani/{id}
async function create(data)         { return svc.create(data);   } // POST /komisyonodemeplani
async function update(id, data)     { return svc.update(id, data);} // PUT  /komisyonodemeplani/{id}
async function remove(id)           { return svc.remove(id);     } // DELETE /komisyonodemeplani/{id}

// (5) Export
export const KomisyonOdemePlaniApi = { list, get, create, update, remove };
export default KomisyonOdemePlaniApi;
