...
// wwwroot/js/api/entities/Opportunity.js
// ======================================================================
...
// (4) CRUD işlevleri
async function list(params = null)  { return svc.list(params);  } // GET /opportunity
async function get(id)              { return svc.get(id);        } // GET /opportunity/{id}
async function create(data)         { return svc.create(data);   } // POST /opportunity
async function update(id, data)     { return svc.update(id, data);} // PUT  /opportunity/{id}
async function remove(id)           { return svc.remove(id);     } // DELETE /opportunity/{id}

// (5) Export
export const OpportunityApi = { list, get, create, update, remove };
