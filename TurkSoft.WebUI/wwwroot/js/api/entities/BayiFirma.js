...
// wwwroot/js/api/entities/BayiFirma.js
// ======================================================================
...
// (4) CRUD işlevleri
async function list(params = null)  { return svc.list(params);  } // GET /bayifirma
async function get(id)              { return svc.get(id);        } // GET /bayifirma/{id}
async function create(data)         { return svc.create(data);   } // POST /bayifirma
async function update(id, data)     { return svc.update(id, data);} // PUT  /bayifirma/{id}
async function remove(id)           { return svc.remove(id);     } // DELETE /bayifirma/{id}

// (5) Export
export const BayiFirmaApi = { list, get, create, update, remove };
export default BayiFirmaApi;
