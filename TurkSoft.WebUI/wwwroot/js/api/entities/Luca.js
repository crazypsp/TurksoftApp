...
// wwwroot/js/api/entities/Luca.js
// ======================================================================
...
// (4) CRUD işlevleri
async function list(params = null)  { return svc.list(params);  } // GET /luca
async function get(id)              { return svc.get(id);        } // GET /luca/{id}
async function create(data)         { return svc.create(data);   } // POST /luca
async function update(id, data)     { return svc.update(id, data);} // PUT  /luca/{id}
async function remove(id)           { return svc.remove(id);     } // DELETE /luca/{id}

// (5) Export
export const LucaApi = { list, get, create, update, remove };
