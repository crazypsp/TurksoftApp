...
// wwwroot/js/api/entities/Kupon.js
// ======================================================================
...
// (4) CRUD işlevleri
async function list(params = null)  { return svc.list(params);  } // GET /kupon
async function get(id)              { return svc.get(id);        } // GET /kupon/{id}
async function create(data)         { return svc.create(data);   } // POST /kupon
async function update(id, data)     { return svc.update(id, data);} // PUT  /kupon/{id}
async function remove(id)           { return svc.remove(id);     } // DELETE /kupon/{id}

// (5) Export
export const KuponApi = { list, get, create, update, remove };
export default KuponApi;
