...
// wwwroot/js/api/entities/PaketIskonto.js
// ======================================================================
...
// (4) CRUD işlevleri
async function list(params = null)  { return svc.list(params);  } // GET /paketiskonto
async function get(id)              { return svc.get(id);        } // GET /paketiskonto/{id}
async function create(data)         { return svc.create(data);   } // POST /paketiskonto
async function update(id, data)     { return svc.update(id, data);} // PUT  /paketiskonto/{id}
async function remove(id)           { return svc.remove(id);     } // DELETE /paketiskonto/{id}

// (5) Export
export const PaketIskontoApi = { list, get, create, update, remove };
export default PaketIskontoApi;
