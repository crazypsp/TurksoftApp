...
// wwwroot/js/api/entities/EtiketIliski.js
// ======================================================================
...
// (4) CRUD işlevleri
async function list(params = null)  { return svc.list(params);  } // GET /etiketiliski
async function get(id)              { return svc.get(id);        } // GET /etiketiliski/{id}
async function create(data)         { return svc.create(data);   } // POST /etiketiliski
async function update(id, data)     { return svc.update(id, data);} // PUT  /etiketiliski/{id}
async function remove(id)           { return svc.remove(id);     } // DELETE /etiketiliski/{id}

// (5) Export
export const EtiketIliskiApi = { list, get, create, update, remove };
export default EtiketIliskiApi;
