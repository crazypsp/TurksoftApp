...
// wwwroot/js/api/entities/WhatsappAyar.js
// ======================================================================
...
// (4) CRUD işlevleri
async function list(params = null)  { return svc.list(params);  } // GET /whatsappayar
async function get(id)              { return svc.get(id);        } // GET /whatsappayar/{id}
async function create(data)         { return svc.create(data);   } // POST /whatsappayar
async function update(id, data)     { return svc.update(id, data);} // PUT  /whatsappayar/{id}
async function remove(id)           { return svc.remove(id);     } // DELETE /whatsappayar/{id}

// (5) Export
export const WhatsappAyarApi = { list, get, create, update, remove };
export default WhatsappAyarApi;
