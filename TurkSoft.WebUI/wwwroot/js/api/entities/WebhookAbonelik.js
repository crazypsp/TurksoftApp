...
// wwwroot/js/api/entities/WebhookAbonelik.js
// ======================================================================
...
const RESOURCE = 'webhookabonelik';
...
// (4) CRUD işlevleri
async function list(params = null)  { return svc.list(params);  } // GET /webhookabonelik
async function get(id)              { return svc.get(id);        } // GET /webhookabonelik/{id}
async function create(data)         { return svc.create(data);   } // POST /webhookabonelik
async function update(id, data)     { return svc.update(id, data);} // PUT  /webhookabonelik/{id}
async function remove(id)           { return svc.remove(id);     } // DELETE /webhookabonelik/{id}

// (5) Export
export const WebhookAbonelikApi = { list, get, create, update, remove };
export default WebhookAbonelikApi;
