...
// wwwroot/js/api/entities/OutboxMesaj.js
// ======================================================================
...
// (4) CRUD işlevleri
async function list(params = null)  { return svc.list(params);  } // GET /outboxmesaj
async function get(id)              { return svc.get(id);        } // GET /outboxmesaj/{id}
async function create(data)         { return svc.create(data);   } // POST /outboxmesaj
async function update(id, data)     { return svc.update(id, data);} // PUT  /outboxmesaj/{id}
async function remove(id)           { return svc.remove(id);     } // DELETE /outboxmesaj/{id}

// (5) Export
export const OutboxMesajApi = { list, get, create, update, remove };
export default OutboxMesajApi;
