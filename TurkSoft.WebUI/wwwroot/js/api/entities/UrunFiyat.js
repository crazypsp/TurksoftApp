...
// wwwroot/js/api/entities/UrunFiyat.js
// ======================================================================
...
// (4) CRUD işlevleri
async function list(params = null)  { return svc.list(params);  } // GET /urunfiyat
async function get(id)              { return svc.get(id);        } // GET /urunfiyat/{id}
async function create(data)         { return svc.create(data);   } // POST /urunfiyat
async function update(id, data)     { return svc.update(id, data);} // PUT  /urunfiyat/{id}
async function remove(id)           { return svc.remove(id);     } // DELETE /urunfiyat/{id}

// (5) Export
export const UrunFiyatApi = { list, get, create, update, remove };
export default UrunFiyatApi;
