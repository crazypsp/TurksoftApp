...
// wwwroot/js/api/entities/Lead.js
// ======================================================================
...
// (4) CRUD işlevleri
async function list(params = null)  { return svc.list(params);  } // GET /lead
async function get(id)              { return svc.get(id);        } // GET /lead/{id}
async function create(data)         { return svc.create(data);   } // POST /lead
async function update(id, data)     { return svc.update(id, data);} // PUT  /lead/{id}
async function remove(id)           { return svc.remove(id);     } // DELETE /lead/{id}

// (5) Export
export const LeadApi = { list, get, create, update, remove };
