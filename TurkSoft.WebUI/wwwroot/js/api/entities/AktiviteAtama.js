...
// (4) CRUD işlevleri
async function list(params = null)  { return svc.list(params);  } // GET /aktiviteatama
async function get(id)              { return svc.get(id);        } // GET /aktiviteatama/{id}
async function create(data)         { return svc.create(data);   } // POST /aktiviteatama
async function update(id, data)     { return svc.update(id, data);} // PUT  /aktiviteatama/{id}
async function remove(id)           { return svc.remove(id);     } // DELETE /aktiviteatama/{id}

// (5) Export
export const AktiviteAtamaApi = { list, get, create, update, remove };
export default AktiviteAtamaApi;
