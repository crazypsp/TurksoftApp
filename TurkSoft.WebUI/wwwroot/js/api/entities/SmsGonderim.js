...
// wwwroot/js/api/entities/SmsGonderim.js
// ======================================================================
...
// (4) CRUD işlevleri
async function list(params = null)  { return svc.list(params);  } // GET /smsgonderim
async function get(id)              { return svc.get(id);        } // GET /smsgonderim/{id}
async function create(data)         { return svc.create(data);   } // POST /smsgonderim
async function update(id, data)     { return svc.update(id, data);} // PUT  /smsgonderim/{id}
async function remove(id)           { return svc.remove(id);     } // DELETE /smsgonderim/{id}

// (5) Export
export const SmsGonderimApi = { list, get, create, update, remove };
export default SmsGonderimApi;
