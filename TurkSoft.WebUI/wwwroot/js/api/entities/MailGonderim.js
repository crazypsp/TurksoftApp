...
// wwwroot/js/api/entities/MailGonderim.js
// ======================================================================
...
// (4) CRUD işlevleri
async function list(params = null)  { return svc.list(params);  } // GET /mailgonderim
async function get(id)              { return svc.get(id);        } // GET /mailgonderim/{id}
async function create(data)         { return svc.create(data);   } // POST /mailgonderim
async function update(id, data)     { return svc.update(id, data);} // PUT  /mailgonderim/{id}
async function remove(id)           { return svc.remove(id);     } // DELETE /mailgonderim/{id}

// (5) Export
export const MailGonderimApi = { list, get, create, update, remove };
export default MailGonderimApi;
