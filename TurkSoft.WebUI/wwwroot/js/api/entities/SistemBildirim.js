...
// wwwroot/js/api/entities/SistemBildirim.js
// ======================================================================
...
// (4) CRUD işlevleri
async function list(params = null)  { return svc.list(params);  } // GET /sistembildirim
async function get(id)              { return svc.get(id);        } // GET /sistembildirim/{id}
async function create(data)         { return svc.create(data);   } // POST /sistembildirim
async function update(id, data)     { return svc.update(id, data);} // PUT  /sistembildirim/{id}
async function remove(id)           { return svc.remove(id);     } // DELETE /sistembildirim/{id}

// (5) Export
export const SistemBildirimApi = { list, get, create, update, remove };
export default SistemBildirimApi;
