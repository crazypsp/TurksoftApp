...
// wwwroot/js/api/entities/Not.js
// ======================================================================
...
// (4) CRUD işlevleri
async function list(params = null)  { return svc.list(params);  } // GET /not
async function get(id)              { return svc.get(id);        } // GET /not/{id}
async function create(data)         { return svc.create(data);   } // POST /not
async function update(id, data)     { return svc.update(id, data);} // PUT  /not/{id}
async function remove(id)           { return svc.remove(id);     } // DELETE /not/{id}

// (5) Export
export const NotApi = { list, get, create, update, remove };
