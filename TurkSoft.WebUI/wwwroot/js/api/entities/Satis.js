...
// wwwroot/js/api/entities/Satis.js
// ======================================================================
...
// (4) CRUD işlevleri
async function list(params = null)  { return svc.list(params);  } // GET /satis
async function get(id)              { return svc.get(id);        } // GET /satis/{id}
async function create(data)         { return svc.create(data);   } // POST /satis
async function update(id, data)     { return svc.update(id, data);} // PUT  /satis/{id}
async function remove(id)           { return svc.remove(id);     } // DELETE /satis/{id}

// (5) Export
export const SatisApi = { list, get, create, update, remove };
export default SatisApi;
