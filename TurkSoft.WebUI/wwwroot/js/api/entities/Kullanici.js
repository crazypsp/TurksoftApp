...
// wwwroot/js/api/entities/Kullanici.js
// ======================================================================
...
// (4) CRUD işlevleri
async function list(params = null)  { return svc.list(params);  } // GET /kullanici
async function get(id)              { return svc.get(id);        } // GET /kullanici/{id}
async function create(data)         { return svc.create(data);   } // POST /kullanici
async function update(id, data)     { return svc.update(id, data);} // PUT  /kullanici/{id}
async function remove(id)           { return svc.remove(id);     } // DELETE /kullanici/{id}

// (5) Export
export const KullaniciApi = { list, get, create, update, remove };
