...
// wwwroot/js/api/entities/Fatura.js
// ======================================================================
...
// (4) CRUD işlevleri
async function list(params = null)  { return svc.list(params);  } // GET /fatura
async function get(id)              { return svc.get(id);        } // GET /fatura/{id}
async function create(data)         { return svc.create(data);   } // POST /fatura
async function update(id, data)     { return svc.update(id, data);} // PUT  /fatura/{id}
async function remove(id)           { return svc.remove(id);     } // DELETE /fatura/{id}

// (5) Export
export const FaturaApi = { list, get, create, update, remove };
export default FaturaApi;
