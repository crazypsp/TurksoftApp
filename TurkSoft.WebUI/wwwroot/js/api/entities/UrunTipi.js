...
// wwwroot/js/api/entities/UrunTipi.js
// ======================================================================
...
// (4) CRUD işlevleri
async function list(params = null)  { return svc.list(params);  } // GET /uruntipi
async function get(id)              { return svc.get(id);        } // GET /uruntipi/{id}
async function create(data)         { return svc.create(data);   } // POST /uruntipi
async function update(id, data)     { return svc.update(id, data);} // PUT  /uruntipi/{id}
async function remove(id)           { return svc.remove(id);     } // DELETE /uruntipi/{id}

// (5) Export
export const UrunTipiApi = { list, get, create, update, remove };
export default UrunTipiApi;
