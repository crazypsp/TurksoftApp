...
// wwwroot/js/api/entities/MaliMusavir.js
// ======================================================================
...
// (4) CRUD işlevleri
async function list(params = null)  { return svc.list(params);  } // GET /malimusavir
async function get(id)              { return svc.get(id);        } // GET /malimusavir/{id}
async function create(data)         { return svc.create(data);   } // POST /malimusavir
async function update(id, data)     { return svc.update(id, data);} // PUT  /malimusavir/{id}
async function remove(id)           { return svc.remove(id);     } // DELETE /malimusavir/{id}

// (5) Export
export const MaliMusavirApi = { list, get, create, update, remove };
export default MaliMusavirApi;
