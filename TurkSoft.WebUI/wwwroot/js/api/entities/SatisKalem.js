...
// wwwroot/js/api/entities/SatisKalem.js
// ======================================================================
...
// (4) CRUD işlevleri
async function list(params = null)  { return svc.list(params);  } // GET /satiskalem
async function get(id)              { return svc.get(id);        } // GET /satiskalem/{id}
async function create(data)         { return svc.create(data);   } // POST /satiskalem
async function update(id, data)     { return svc.update(id, data);} // PUT  /satiskalem/{id}
async function remove(id)           { return svc.remove(id);     } // DELETE /satiskalem/{id}

// (5) Export
export const SatisKalemApi = { list, get, create, update, remove };
export default SatisKalemApi;
