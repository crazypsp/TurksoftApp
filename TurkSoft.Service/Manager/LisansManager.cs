...
// Lisans adındaki Entity (veritabanı tablosunu temsil eden sınıf).
...
namespace TurkSoft.Service.Manager
{
    ...
    // ILisansService arayüzünü (interface) implement ederek, bu interface'de tanımlanan tüm metodları somut olarak uygular.
    public class LisansManager : ILisansService
    {
        ...
        private readonly IBaseService<Lisans> _baseBusiness;

        // Constructor (yapıcı metod), dışarıdan bu sınıfa IBaseService<Lisans> türünde bir bağımlılık (dependency) enjekte eder.
        // Dependency Injection (DI) prensibi sayesinde loosely-coupled (gevşek bağlı) bir yapı elde edilir.
        public LisansManager(IBaseService<Lisans> baseBusiness)
        {
        ...
        public async Task<Lisans> AddAsync(Lisans entity)
        {
        ...
        public async Task<List<Lisans>> GetAllAsync()
        {
        ...
        public async Task<Lisans> GetByIdAsync(Guid id)
        {
        ...
        public async Task<Lisans> UpdateAsync(Lisans entity)
        {
