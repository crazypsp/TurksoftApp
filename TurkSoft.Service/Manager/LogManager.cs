...
// Log adındaki Entity (veritabanı tablosunu temsil eden sınıf).
...
namespace TurkSoft.Service.Manager
{
    ...
    // ILogService arayüzünü (interface) implement ederek, bu interface'de tanımlanan tüm metodları somut olarak uygular.
    public class LogManager : ILogService
    {
        ...
        private readonly IBaseService<Log> _baseBusiness;

        // Constructor (yapıcı metod), dışarıdan bu sınıfa IBaseService<Log> türünde bir bağımlılık (dependency) enjekte eder.
        // Dependency Injection (DI) prensibi sayesinde loosely-coupled (gevşek bağlı) bir yapı elde edilir.
        public LogManager(IBaseService<Log> baseBusiness)
        {
