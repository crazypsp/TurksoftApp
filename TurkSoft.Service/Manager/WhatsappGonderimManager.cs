...
// WhatsappGonderim adındaki Entity (veritabanı tablosunu temsil eden sınıf).
...
namespace TurkSoft.Service.Manager
{
    ...
    // IWhatsappGonderimService arayüzünü (interface) implement ederek, bu interface'de tanımlanan tüm metodları somut olarak uygular.
    public class WhatsappGonderimManager : IWhatsappGonderimService
    {
        ...
        private readonly IBaseService<WhatsappGonderim> _baseBusiness;

        // Constructor (yapıcı metod), dışarıdan bu sınıfa IBaseService<WhatsappGonderim> türünde bir bağımlılık (dependency) enjekte eder.
        // Dependency Injection (DI) prensibi sayesinde loosely-coupled (gevşek bağlı) bir yapı elde edilir.
        public WhatsappGonderimManager(IBaseService<WhatsappGonderim> baseBusiness)
        {
        ...
        public async Task<WhatsappGonderim> AddAsync(WhatsappGonderim entity)
        {
        ...
        public async Task<List<WhatsappGonderim>> GetAllAsync()
        {
        ...
        public async Task<WhatsappGonderim> GetByIdAsync(Guid id)
        {
        ...
        public async Task<WhatsappGonderim> UpdateAsync(WhatsappGonderim entity)
        {
