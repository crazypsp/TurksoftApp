...
namespace TurkSoft.Service.Manager
{
    ...
    public class SmsAyarManager : ISmsAyarService
    {
        ...
        private readonly IBaseService<SmsAyar> _baseBusiness;
        ...
        public SmsAyarManager(IBaseService<SmsAyar> baseBusiness)
        {
        ...
        public async Task<SmsAyar> AddAsync(SmsAyar entity)
        {
        ...
        public async Task<List<SmsAyar>> GetAllAsync()
        {
        ...
        public async Task<SmsAyar> GetByIdAsync(Guid id)
        {
        ...
        public async Task<SmsAyar> UpdateAsync(SmsAyar entity)
        {
