...
// MailGonderim adındaki Entity (veritabanı tablosunu temsil eden sınıf).
...
namespace TurkSoft.Service.Manager
{
    ...
    // IMailGonderimService arayüzünü (interface) implement ederek, bu interface'de tanımlanan tüm metodları somut olarak uygular.
    public class MailGonderimManager : IMailGonderimService
    {
        ...
        private readonly IBaseService<MailGonderim> _baseBusiness;

        // Constructor (yapıcı metod), dışarıdan bu sınıfa IBaseService<MailGonderim> türünde bir bağımlılık (dependency) enjekte eder.
        // Dependency Injection (DI) prensibi sayesinde loosely-coupled (gevşek bağlı) bir yapı elde edilir.
        public MailGonderimManager(IBaseService<MailGonderim> baseBusiness)
        {
        ...
        public async Task<MailGonderim> AddAsync(MailGonderim entity)
        {
        ...
        public async Task<List<MailGonderim>> GetAllAsync()
        {
        ...
        public async Task<MailGonderim> GetByIdAsync(Guid id)
        {
        ...
        public async Task<MailGonderim> UpdateAsync(MailGonderim entity)
        {
