...
namespace TurkSoft.Service.Manager
{
    ...
    // ILucaService arayüzünü (interface) implement ederek, bu interface'de tanımlanan tüm metodları somut olarak uygular.
    public class LucaManager : ILucaService
    {
        ...
        private readonly IBaseService<Luca> _baseBusiness;
        ...
        public LucaManager(IBaseService<Luca> baseBusiness)
        {
        ...
        public async Task<Luca> AddAsync(Luca entity)
        {
        ...
        public async Task<List<Luca>> GetAllAsync()
        {
        ...
        public async Task<Luca> GetByIdAsync(Guid id)
        {
        ...
        public async Task<Luca> UpdateAsync(Luca entity)
        {
