...
// LisansAdet adındaki Entity (veritabanı tablosunu temsil eden sınıf).
...
namespace TurkSoft.Service.Manager
{
    ...
    // ILisansAdetService arayüzünü (interface) implement ederek, bu interface'de tanımlanan tüm metodları somut olarak uygular.
    public class LisansAdetManager : ILisansAdetService
    {
        ...
        private readonly IBaseService<LisansAdet> _baseBusiness;

        // Constructor (yapıcı metod), dışarıdan bu sınıfa IBaseService<LisansAdet> türünde bir bağımlılık (dependency) enjekte eder.
        // Dependency Injection (DI) prensibi sayesinde loosely-coupled (gevşek bağlı) bir yapı elde edilir.
        public LisansAdetManager(IBaseService<LisansAdet> baseBusiness)
        {
        ...
        public async Task<LisansAdet> AddAsync(LisansAdet entity)
        {
        ...
        public async Task<List<LisansAdet>> GetAllAsync()
        {
        ...
        public async Task<LisansAdet> GetByIdAsync(Guid id)
        {
        ...
        public async Task<LisansAdet> UpdateAsync(LisansAdet entity)
        {
