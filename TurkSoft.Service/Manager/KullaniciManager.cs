...
// Kullanici adındaki Entity (veritabanı tablosunu temsil eden sınıf).
...
namespace TurkSoft.Service.Manager
{
    ...
    // IKullaniciService arayüzünü (interface) implement ederek, bu interface'de tanımlanan tüm metodları somut olarak uygular.
    public class KullaniciManager : IKullaniciService
    {
        ...
        private readonly IBaseService<Kullanici> _baseBusiness;

        // Constructor (yapıcı metod), dışarıdan bu sınıfa IBaseService<Kullanici> türünde bir bağımlılık (dependency) enjekte eder.
        // Dependency Injection (DI) prensibi sayesinde loosely-coupled (gevşek bağlı) bir yapı elde edilir.
        public KullaniciManager(IBaseService<Kullanici> baseBusiness)
        {
