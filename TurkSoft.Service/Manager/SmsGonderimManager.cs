...
// SmsGonderim adındaki Entity (veritabanı tablosunu temsil eden sınıf).
...
namespace TurkSoft.Service.Manager
{
    ...
    // ISmsGonderimService arayüzünü (interface) implement ederek, bu interface'de tanımlanan tüm metodları somut olarak uygular.
    public class SmsGonderimManager : ISmsGonderimService
    {
        ...
        private readonly IBaseService<SmsGonderim> _baseBusiness;

        // Constructor (yapıcı metod), dışarıdan bu sınıfa IBaseService<SmsGonderim> türünde bir bağımlılık (dependency) enjekte eder.
        // Dependency Injection (DI) prensibi sayesinde loosely-coupled (gevşek bağlı) bir yapı elde edilir.
        public SmsGonderimManager(IBaseService<SmsGonderim> baseBusiness)
        {
        ...
        public async Task<SmsGonderim> AddAsync(SmsGonderim entity)
        {
        ...
        public async Task<List<SmsGonderim>> GetAllAsync()
        {
        ...
        public async Task<SmsGonderim> GetByIdAsync(Guid id)
        {
        ...
        public async Task<SmsGonderim> UpdateAsync(SmsGonderim entity)
        {
