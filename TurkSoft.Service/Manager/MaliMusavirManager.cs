...
// MaliMusavir adındaki Entity (veritabanı tablosunu temsil eden sınıf).
...
namespace TurkSoft.Service.Manager
{
    ...
    // IMaliMusavirService arayüzünü (interface) implement ederek, bu interface'de tanımlanan tüm metodları somut olarak uygular.
    public class MaliMusavirManager : IMaliMusavirService
    {
        ...
        private readonly IBaseService<MaliMusavir> _baseBusiness;

        // Constructor (yapıcı metod), dışarıdan bu sınıfa IBaseService<MaliMusavir> türünde bir bağımlılık (dependency) enjekte eder.
        // Dependency Injection (DI) prensibi sayesinde loosely-coupled (gevşek bağlı) bir yapı elde edilir.
        public MaliMusavirManager(IBaseService<MaliMusavir> baseBusiness)
        {
        ...
        public async Task<MaliMusavir> AddAsync(MaliMusavir entity)
        {
        ...
        public async Task<List<MaliMusavir>> GetAllAsync()
        {
        ...
        public async Task<MaliMusavir> GetByIdAsync(Guid id)
        {
        ...
        public async Task<MaliMusavir> UpdateAsync(MaliMusavir entity)
        {
