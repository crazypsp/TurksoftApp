...
{
    /// <inheritdoc />
    public partial class CreateTurksoftDb : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TaxNo = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    TaxOffice = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    TaxOfficeProvince = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    PersonalFirstName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    CustomerRepresentative = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    ResponsibleTckn = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ResponsibleFirstName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ResponsibleLastName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ResponsibleMobilePhone = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ResponsibleEmail = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedByPersonFirstName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedByPersonLastName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    CreatedByPersonMobilePhone = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GibFirmService", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GibFirmService_GibFirm_GibFirmId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GibFirmServiceAlias", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GibFirmServiceAlias_GibFirmService_GibFirmServiceId",
                        column: x => x.GibFirmServiceId,
                        principalTable: "GibFirmService",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GibFirmService_GibFirmId",
                table: "GibFirmService",
                column: "GibFirmId");

            migrationBuilder.CreateIndex(
                name: "IX_GibFirmServiceAlias_GibFirmServiceId",
                table: "GibFirmServiceAlias",
